...
package TanyaServices.service.persistence.impl;

import TanyaServices.exception.NoSuchServicesException;

import TanyaServices.model.Services;
import TanyaServices.model.ServicesTable;
import TanyaServices.model.impl.ServicesImpl;
import TanyaServices.model.impl.ServicesModelImpl;

import TanyaServices.service.persistence.ServicesPersistence;
import TanyaServices.service.persistence.ServicesUtil;
import TanyaServices.service.persistence.impl.constants.tanyaPersistenceConstants;
...
public class ServicesPersistenceImpl
	...
	@Override
	@Reference(
		target = tanyaPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = tanyaPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
