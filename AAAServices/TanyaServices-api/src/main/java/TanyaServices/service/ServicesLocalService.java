...
public interface ServicesLocalService
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Services> getServicesByGroupId(long groupId, int start, int end)
		throws SystemException;
