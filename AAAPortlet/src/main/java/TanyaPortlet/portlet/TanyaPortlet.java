package TanyaPortlet.portlet;

import TanyaPortlet.constants.TanyaPortletKeys;
...
import TanyaServices.service.ServicesLocalService;
import TanyaServices.service.ServicesLocalServiceUtil;
...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=Tanya",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/view.jsp",
		"javax.portlet.name=" + TanyaPortletKeys.TANYA,
		"javax.portlet.resource-bundle=content.Language",
		"javax.portlet.security-role-ref=power-user,user"
	},
	service = Portlet.class
)
public class TanyaPortlet extends MVCPortlet {
    ...
    private static Log _log = LogFactoryUtil.getLog(TanyaPortlet.class);
